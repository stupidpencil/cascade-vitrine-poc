...
---
title: All features
description: The full breakdown of Cascade's functional modules — what exists today, and what becomes automated over time.
---
::
...
lots:
  ...
  - icon: i-lucide-layout-template
    ...
    features:
      ...
      - Fixed, configurable, or flexible amount
      - Billing by invoice or by notification
      - Contract or simple membership, with a contract and amendment template
    automation: A single model, applied automatically to every new subscription — no rules to re-enter.
  - icon: i-lucide-file-signature
    title: Subscriptions
    description: Centralize each contributor's subscriptions, derived from a model, along with their terms of use.
    ...
    features:
      ...
      - Amendments linked to the original subscription
